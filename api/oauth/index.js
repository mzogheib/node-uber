...
const deauthorize = ({ access_token, client_id, client_secret }) => {
  const data = { token: access_token, client_id, client_secret };
  return http.post({ baseUrl: baseOauthUrl, url: '/revoke', data });
}
